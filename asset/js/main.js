...
//         }
//         else{
//             // if email more than 5 characters
//             if(email.includes('@')){
...
//             // check is full name is less than 5 characters
//             message = 'Please fill name form correctly';
//             formValid = false;
//         }
//         else{
...
//             formValid = false;
//             message = ' Please fill the correc birth date!';
//         }
...
// // detect when user click the disagree area
// disagreeButton.addEventListener('click', function(e){
//     e.preventDefault();

//     // get disagree area value
//     var disagreeValue = disagreeButton.getAttribute('data-value');
     
//     // assign disagree value into ToS hidden form
//     var tos = document.getElementById('tos');
